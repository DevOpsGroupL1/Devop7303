...
//		    System.out.println(">>>>>>>>...1");
    ...
    public void schedulingNotification(String patientName, String patientEmailAddress, String subject, String msg) {
        try {
            LocalDateTime date = LocalDateTime.now();
            DateTimeFormatter formatter = DateTimeFormatter.ofPattern("MMMM dd, yyyy hh:mm:ss a");
            String text = date.format(formatter);
            LocalDateTime parsedDate = LocalDateTime.parse(text, formatter);
            String toAddress = patientEmailAddress;
            String fromAddress = "noreply@bountyapp.ng";
            String senderName = "Group L1";
            String domain = "http://localhost:8080/devop7303";
            String content = "<h3>Dear "+patientName+",</h3>"
                    + msg
                    + "<p><a href='"+domain+"'>Click Here to visit the portal</a>"+"</p><br>"
                    + "<h3>Group L1 Team</h3>"
                    + "<br><br><div style=\"text-align:center\">Copyright © 2025. All Rights Reserved. Devop7307 Group L1</div>";
//		    System.out.println(">>>>>>>>...1");
